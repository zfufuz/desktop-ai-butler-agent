...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  loadConversation: (conversationId: string) => ipcRenderer.invoke('conversation:load', conversationId),
  saveConversation: (conversationId: string, messages: unknown) => ipcRenderer.invoke('conversation:save', conversationId, messages),
  ...
  discoverMcpServer: (serverId: string) => ipcRenderer.invoke('mcp:discover', serverId),
  invokeMcpTool: (serverId: string, toolName: string, input: unknown) => ipcRenderer.invoke('mcp:invoke', serverId, toolName, input),

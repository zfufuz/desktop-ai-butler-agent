...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getScheduledAgentJobs: () => ipcRenderer.invoke('automation:list'),
  saveScheduledAgentJob: (job: unknown) => ipcRenderer.invoke('automation:save', job),
  deleteScheduledAgentJob: (jobId: string) => ipcRenderer.invoke('automation:delete', jobId),
  claimDueScheduledAgentJob: () => ipcRenderer.invoke('automation:claim-due'),
  claimScheduledAgentJobNow: (jobId: string) => ipcRenderer.invoke('automation:claim-now', jobId),
  completeScheduledAgentJob: (jobId: string, success: boolean, result?: string) => ipcRenderer.invoke('automation:complete', jobId, success, result),
